# GitHub Advanced Security (GHAS) Feature Matrix — Archived Versions (2026)

> **Archive notice:** This file contains a snapshot of GHAS feature data for GHES versions that have reached end of life as of 2026: **GHES 3.14, 3.15, 3.16, and 3.17**. For the current supported versions, see the [active matrix](../../GHAS-on-GHES-feature-matrix.md).
...
|---------|----|----|----|----|
|Release date| 2024-08-27 | 2024-12-03 | 2025-03-11 | 2025-06-03 |
|Deprecation date | 2026-04-09 | 2026-04-09 | 2026-06-02 | 2026-08-25 |
|| [Notes](https://docs.github.com/en/enterprise-server@3.14/admin/release-notes) | [Notes](https://docs.github.com/en/enterprise-server@3.15/admin/release-notes) | [Notes](https://docs.github.com/en/enterprise-server@3.16/admin/release-notes) | [Notes](https://docs.github.com/en/enterprise-server@3.17/admin/release-notes) |
...
|Feature  |3.14|3.15|3.16|3.17|
|------------------------------------------------------------|-----|-----|-----|-----|
|[Partner pattern count](https://docs.github.com/en/enterprise-server/code-security/secret-scanning/secret-scanning-patterns)|274|286|289|321|
