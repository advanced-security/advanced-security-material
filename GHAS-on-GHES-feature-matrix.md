...
|------------------------------------------------------------|-----|-----|-----|-----|-----|-----|-----|-----|-----|
|[Partner pattern count](https://docs.github.com/en/enterprise-server/code-security/secret-scanning/secret-scanning-patterns)|249|274|274|286|289|321|347|370|478|
...
| [Secret scanning validity checks](https://docs.github.com/en/enterprise-server@3.20/code-security/secret-scanning/managing-alerts-from-secret-scanning/about-alerts) |||||||||✅|
| [Alert assignees for secret scanning](https://docs.github.com/en/enterprise-server@3.20/code-security/secret-scanning/managing-alerts-from-secret-scanning) |||||||||✅|
| [Enterprise-level delegated bypass for secret scanning push protection](https://docs.github.com/en/enterprise-server@3.20/code-security/secret-scanning/push-protection-for-repositories-and-organizations) |||||||||✅|
...
| [Dependabot version updates support for Conda dependencies](https://docs.github.com/en/enterprise-server@3.20/code-security/dependabot/ecosystems-supported-by-dependabot/supported-ecosystems-and-repositories#supported-ecosystems-and-repositories) |||||||||✅|
...
| [Enterprise Security Manager role](https://docs.github.com/en/enterprise-server@3.20/organizations/managing-peoples-access-to-your-organization-with-roles/managing-security-managers-in-your-organization) |||||||||☑️|
