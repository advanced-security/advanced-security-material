...
#### End of life Archive
- [2022 - 2024 GHES 3.4 - GHES 3.13](./advanced-security/archive/GHAS-on-GHES-feature-matrix-2025.md)
...
|Version  |3.17|3.18|3.19|3.20|3.21|3.22|
|---------|----|----|----|----|----|----|
|Release date| 2025-06-03 | 2025-10-14 | 2025-12-09 | 2026-03-17 | 2026-06-11 | 2026-09-08 |
|Deprecation date | 2026-09-22 | 2026-10-14 | 2026-12-09 | 2027-03-17 | 2027-06-11 | 2027-09-08 |
...
|Feature  |3.17|3.18|3.19|3.20|3.21|3.22|
|------------------------------------------------------------|----|----|----|----|----|----|
|[Partner pattern count](https://docs.github.com/en/enterprise-server/code-security/secret-scanning/secret-scanning-patterns)|321|347|370|452|501|519|
|[Non-provider patterns](https://github.blog/changelog/2023-11-06-secret-scanning-expands-detection-to-include-non-provider-patterns-beta/)|✅|✅|✅|✅|✅|✅|
...
| [Push Protection Bypass](https://docs.github.com/en/enterprise-server@3.14/code-security/secret-scanning/push-protection-for-repositories-and-organizations#enabling-delegated-bypass-for-push-protection) |✅|✅|✅|✅|✅|✅|
| [Detect secrets leaked in discussions and in pull request titles, bodies, and comments](https://docs.github.com/en/enterprise-server@3.14/code-security/secret-scanning/about-secret-scanning) |✅|✅|✅|✅|✅|✅|
| Push protection on file upload |✅|✅|✅|✅|✅|✅|
...
| [Sort secret scanning push protection bypass and alert dismissal requests by date](https://docs.github.com/en/enterprise-server@3.22/code-security/secret-scanning/managing-alerts-from-secret-scanning) |  |  |  |  |  | ✅ |
| [Custom validity states for secret scanning alerts from custom patterns via REST API](https://docs.github.com/en/enterprise-server@3.22/rest/secret-scanning/secret-scanning) |  |  |  |  |  | ✅ |
| [Repository-level push protection exemptions for trusted actors](https://docs.github.com/en/enterprise-server@3.22/code-security/how-tos/secure-your-secrets/manage-bypass-requests/grant-exemptions) |  |  |  |  |  | ✅ |
...
|Feature  |3.17|3.18|3.19|3.20|3.21|3.22|
|------------------------------------------------------------|----|----|----|----|----|----|
|[CodeQL "toolcache" Version](https://docs.github.com/en/enterprise-server/admin/code-security/managing-github-advanced-security-for-your-enterprise/configuring-code-scanning-for-your-appliance#provisioning-the-actions-for-code-scanning)|[2.20.7](https://docs.github.com/en/enterprise-server@3.17/admin/release-notes#code-scanning)|[2.21.4](https://github.blog/changelog/2025-06-10-codeql-2-21-4-adds-swift-6-1-1-support/)|[2.22.4](https://github.blog/changelog/2025-09-03-codeql-2-22-4-adds-support-for-go-1-25-and-accuracy-improvements/)|[2.23.9](https://codeql.github.com/docs/codeql-overview/codeql-changelog/codeql-cli-2.23.9/)|[2.24.3](https://codeql.github.com/docs/codeql-overview/codeql-changelog/codeql-cli-2.24.3/)|[2.25.6](https://codeql.github.com/docs/codeql-overview/codeql-changelog/codeql-cli-2.25.6/)|
|[Kotlin language support](https://github.blog/changelog/2022-11-28-codeql-code-scanning-launches-kotlin-analysis-support-beta/)|✅|✅|✅|✅|✅|✅|
|[CodeQL supports Swift programming language](https://github.blog/changelog/2023-06-01-codeql-code-scanning-now-supports-swift-beta/)|✅|✅|✅|✅|✅|✅|
|[CodeQL threat models for detecting relevant alerts](https://docs.github.com/en/enterprise-server@3.13/code-security/code-scanning/creating-an-advanced-setup-for-code-scanning/customizing-your-advanced-setup-for-code-scanning#extending-codeql-coverage-with-threat-models)|✅|✅|✅|✅|✅|✅|
|[Code Scanning merge protection rulesets](https://docs.github.com/en/enterprise-server@3.14/code-security/code-scanning/managing-your-code-scanning-configuration/set-code-scanning-merge-protection)|✅|✅|✅|✅|✅|✅|
|[CodeQL threat models for default setup](https://docs.github.com/en/enterprise-server@3.14/code-security/code-scanning/managing-your-code-scanning-configuration/editing-your-configuration-of-default-setup#including-local-sources-of-tainted-data-in-default-setup)|✅|✅|✅|✅|✅|✅|
|[CodeQL model packs for organization/repo](https://docs.github.com/en/enterprise-server@3.14/code-security/code-scanning/managing-your-code-scanning-configuration/editing-your-configuration-of-default-setup#extending-codeql-coverage-with-codeql-model-packs-in-default-setup)|✅|✅|✅|✅|✅|✅|
|[CodeQL can scan Java projects without a build](https://docs.github.com/en/enterprise-server@3.15/code-security/code-scanning/creating-an-advanced-setup-for-code-scanning/codeql-code-scanning-for-compiled-languages#codeql-build-modes)|✅|✅|✅|✅|✅|✅|
|[CodeQL can scan C# projects without a build](https://docs.github.com/en/enterprise-server@3.15/code-security/code-scanning/creating-an-advanced-setup-for-code-scanning/codeql-code-scanning-for-compiled-languages#codeql-build-modes)  |✅|✅|✅|✅|✅|✅|
...
| [Code scanning alert assignment](https://docs.github.com/en/enterprise-server@latest/code-security/code-scanning/managing-code-scanning-alerts/managing-code-scanning-alerts-for-your-repository#assigning-an-alert-to-a-team-member) ||||☑️|✅|✅|
...
| [Incremental CodeQL analysis for pull requests](https://github.blog/changelog/2026-06-10-incremental-analysis-for-go-c-c-and-codeql-cli/) and [Ruby and Java](https://github.blog/changelog/2026-03-24-faster-incremental-analysis-with-codeql-in-pull-requests/) |  |  |  |  |  | ✅ |
| [Code scanning alerts can be linked to GitHub Issues](https://github.blog/changelog/2026-04-14-link-code-scanning-alerts-to-github-issues/) |  |  |  |  |  | ☑️ |
| [CodeQL data extensions support custom data flow barriers and sanitizer models](https://codeql.github.com/docs/codeql-overview/codeql-changelog/codeql-cli-2.25.0/) |  |  |  |  |  | ✅ |
| [CodeQL analysis covers composite action metadata files](https://codeql.github.com/docs/codeql-overview/codeql-changelog/codeql-cli-2.25.0/) |  |  |  |  |  | ✅ |
...
|Feature  |3.17|3.18|3.19|3.20|3.21|3.22|
|------------------------------------------------------------|----|----|----|----|----|----|
|[Dependabot alerts show vulnerable function calls](https://web.archive.org/web/20230922181508/https://github.blog/2022-04-14-dependabot-alerts-now-surface-if-code-is-calling-vulnerability/)|||||||
...
| [Organization-level OIDC authentication for Dependabot and code scanning private registries](https://docs.github.com/en/enterprise-server@3.22/code-security/dependabot/working-with-dependabot/configuring-access-to-private-registries-for-dependabot#configuring-access-to-a-private-registry-in-your-organization) |  |  |  |  |  | ✅ |
| [Multiple private registries per ecosystem](https://docs.github.com/en/enterprise-server@3.22/code-security/reference/supply-chain-security/dependabot-options-reference) |  |  |  |  |  | ✅ |
| [Dependabot version updates support for Deno](https://github.blog/changelog/2026-06-09-dependabot-version-updates-now-support-the-deno-ecosystem/) |  |  |  |  |  | ✅ |
| [Dependabot version updates support for sbt](https://github.blog/changelog/2026-05-26-dependabot-version-updates-now-support-the-sbt-ecosystem/) |  |  |  |  |  | ✅ |
| [Dependabot version and security updates support Poetry v2](https://github.blog/changelog/2026-04-23-dependabot-graphs-for-python/) |  |  |  |  |  | ✅ |
| [Cross-organization Dependabot access to internal and private repositories](https://github.blog/changelog/2026-04-28-cross-org-dependabot-access-for-internal-repositories/) |  |  |  |  |  | ✅ |
| [Dependabot version updates support for the Nix ecosystem](https://github.blog/changelog/2026-04-07-dependabot-version-updates-now-support-the-nix-ecosystem/) |  |  |  |  |  | ✅ |
| [Dependabot version updates support Swift packages in Xcode projects](https://github.blog/changelog/2026-03-31-dependabot-now-supports-xcode-projects-using-swiftpm-with-xcodeproj-manifests/) |  |  |  |  |  | ✅ |
...
|Security overview dashboard filter by security tool|✅|✅|✅|✅|✅|✅|
...
| [Security Overview filter bar for delegated bypass requests](https://github.blog/changelog/2026-04-16-rule-insights-dashboard-and-unified-filter-bar/) |  |  |  |  |  | ✅ |
| [Security Overview includes CodeQL alerts from pull request analysis on non-default branches](https://docs.github.com/en/enterprise-server@3.22/code-security/security-overview/viewing-security-insights) |  |  |  |  |  | ✅ |
...
| [Enterprise Security Manager role](https://docs.github.com/en/enterprise-server@latest/admin/managing-accounts-and-repositories/managing-users-in-your-enterprise/roles-in-an-enterprise#security-managers) | | | |☑️|☑️|☑️|
...
| [Security configurations setup wizard](https://docs.github.com/en/enterprise-server@3.22/code-security/how-tos/secure-at-scale/configure-organization-security) |  |  |  |  |  | ✅ |
| [Enterprise-wide disablement of GitHub Advanced Security for private and internal repositories](https://docs.github.com/en/enterprise-server@3.22/billing/how-tos/products/disable-ghas-for-enterprise) |  |  |  |  |  | ✅ |
