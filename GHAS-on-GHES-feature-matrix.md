...
|------------------------------------------------------------|-----|-----|-----|-----|-----|-----|-----|-----|
|[Partner pattern count](https://docs.github.com/en/enterprise-server/code-security/secret-scanning/secret-scanning-patterns)|249|274|274|286|289|321|347|373|
...
| [Configurable secret scanning patterns in push protection](https://docs.github.com/en/enterprise-server@3.19/code-security/secret-scanning/using-advanced-secret-scanning-and-push-protection-features/push-protection/configuring-push-protection) |||||||  |✅|
| [REST API returns first_location_detected and has_more_locations fields](https://docs.github.com/en/enterprise-server@3.19/rest/secret-scanning) |||||||  |✅|
| [Secret scanning detects secrets in GitHub wikis](https://docs.github.com/en/enterprise-server@3.19/code-security/secret-scanning/introduction/about-secret-scanning) |||||||  |✅|
...
| [Delegated alert dismissal for code scanning](https://github.blog/changelog/2025-07-01-delegated-alert-dismissal-for-code-scanning-is-now-generally-available/) ||||||☑️|✅|✅|
...
| [Security configurations support for default or advanced CodeQL setup](https://github.blog/changelog/2025-07-15-security-configurations-support-for-running-codeql-in-either-default-or-advanced-setup/) ||||||||✅|
| [Multi-run SARIF files processed as separate scans](https://github.blog/changelog/2025-07-21-code-scanning-will-stop-combining-multiple-sarif-runs-uploaded-in-the-same-sarif-file/) ||||||||✅|
| [CodeQL Rust support](https://github.blog/changelog/2025-07-03-codeql-2-22-1-bring-rust-support-to-public-preview/) ||||||||☑️|
| [CodeQL Swift 6.1.2 support](https://github.blog/changelog/2025-06-12-codeql-2-22-0-improves-coverage-for-go-and-adds-support-for-swift-6-1-2/) ||||||||✅|
| [CodeQL Go 1.25 support](https://github.blog/changelog/2025-09-03-codeql-2-22-4-adds-support-for-go-1-25-and-accuracy-improvements/) ||||||||✅|
...
| [Dependabot metrics page for prioritization](https://docs.github.com/en/enterprise-server@3.19/code-security/dependabot/dependabot-alerts/viewing-and-updating-dependabot-alerts) ||||||||✅|
...
| [Gradle lockfiles support](https://docs.github.com/en/enterprise-server@3.19/code-security/dependabot/dependabot-version-updates/about-dependabot-version-updates) ||||||||✅|
| [Minimum age configuration for package updates](https://docs.github.com/en/enterprise-server@3.19/code-security/dependabot/dependabot-version-updates/configuration-options-for-the-dependabot.yml-file) ||||||||✅|
| [Cross-ecosystem grouped updates in single PR](https://docs.github.com/en/enterprise-server@3.19/code-security/dependabot/dependabot-version-updates/configuration-options-for-the-dependabot.yml-file#groups) ||||||||✅|
...
| [Dependabot version updates support for vcpkg](https://github.blog/changelog/2025-08-12-dependabot-version-updates-now-support-vcpkg/) ||||||||✅|
| [Dependabot Rust toolchain updates](https://github.blog/changelog/2025-08-19-dependabot-now-supports-rust-toolchain-updates/) ||||||||✅|
| [Exclude PRs for manifests in selected subdirectories](https://github.blog/changelog/2025-08-26-dependabot-can-now-exclude-automatic-pull-requests-for-manifests-in-selected-subdirectories/) ||||||||✅|
| [Private Go modules support](https://docs.github.com/en/enterprise-server@3.19/code-security/dependabot/working-with-dependabot/guidance-for-the-configuration-of-private-registries-for-dependabot) ||||||||✅|
...
| [Enterprise custom organization roles](https://docs.github.com/en/enterprise-server@3.19/admin/managing-accounts-and-repositories/managing-organizations-in-your-enterprise/configuring-custom-organization-roles) ||||||||✅|
| ["Not set" option in security configurations](https://docs.github.com/en/enterprise-server@3.19/code-security/securing-your-organization/enabling-security-features-in-your-organization/creating-a-custom-security-configuration) ||||||||✅|
| [Ruleset history, import, and export](https://docs.github.com/en/enterprise-server@3.19/repositories/configuring-branches-and-merges-in-your-repository/managing-rulesets/about-rulesets) ||||||||✅|
